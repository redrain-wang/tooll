...
const tools=[
  ...
  {path:'/mermaid-chart',icon:'📊',key:'mermaid-chart',descKey:'mermaid-chart-desc',cat:'dev'},
  {path:'/data-chart',icon:'📈',key:'data-chart',descKey:'data-chart-desc',cat:'dev'},
  {path:'/code-runner',icon:'▶️',key:'code-runner',descKey:'code-runner-desc',cat:'dev'},
  ...
  {path:'/drawing-board',icon:'🎨',key:'drawing-board',descKey:'drawing-board-desc',cat:'gen'},
