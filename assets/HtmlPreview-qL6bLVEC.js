import{e as c,B as b,D as y,c as x,a as e,t as a,u as l,w as _,v as f,q as v,s as m,h as o,o as w}from"./index-BlJjmVdP.js";const g={class:"tool-container"},k={class:"text-2xl font-bold mb-2"},C={class:"mb-6",style:{color:"var(--text-secondary)"}},T={class:"space-y-4"},D={class:"grid md:grid-cols-2 gap-6"},B={class:"space-y-4"},H={class:"flex items-center justify-between"},j={class:"text-sm",style:{color:"var(--text-secondary)"}},E={class:"flex gap-2"},M=["placeholder"],P={class:"space-y-4"},U={class:"flex items-center justify-between"},z={class:"text-sm",style:{color:"var(--text-secondary)"}},S={class:"flex gap-2"},V={class:"rounded-xl border overflow-hidden flex justify-center",style:{background:"var(--bg)","border-color":"var(--border)","min-height":"320px"}},$=["srcdoc"],L={__name:"HtmlPreview",setup(q){const s=c(`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
