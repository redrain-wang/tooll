import{z as y,c as p,a as e,t,u as r,F as v,r as h,w as k,v as w,n as _,e as d,h as s,o as u}from"./index-mlnTUTyq.js";const C={class:"tool-container"},B={class:"text-2xl font-bold mb-2"},T={class:"mb-6",style:{color:"var(--text-secondary)"}},S={class:"mb-4 flex gap-2 flex-wrap"},z=["onClick"],E={class:"grid lg:grid-cols-2 gap-6"},H={class:"mb-2 text-sm font-medium",style:{color:"var(--text-secondary)"}},D={class:"rounded-xl border overflow-hidden",style:{"border-color":"var(--border)"}},I=["srcdoc"],L={class:"mt-4 flex gap-3 flex-wrap"},F={__name:"CodeRunner",setup(M){const n=d(`<div class="box">Hello, ToolBox!</div>
<style>
